...
export function SkillCard({ image, name }: SkillCardProps) {
  return (
    <div className="max-sm:w-[7rem] max-sm:h-[7rem] group relative flex h-[8.75rem] w-[8.75rem] items-center justify-center overflow-hidden rounded-lg border border-gray-500 bg-zinc-800">
      <div className="max-sm:h-12 max-sm:w-12 relative h-16 w-16">
